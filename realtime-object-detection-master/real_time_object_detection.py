...
ap.add_argument("-p", "--prototxt", required = True,  help = "./realtime-object-detection-master/MobileNetSSD_deploy.prototxt.txt")
ap.add_argument("-m", "--model", required = True, help = "./realtime-object-detection-master/MobileNetSSD_deploy.caffemodel")
ap.add_argument("-c", "--probability", type = float, default = 0.2, help = 0.5)
